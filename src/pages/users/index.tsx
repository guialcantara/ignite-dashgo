...
export default function UserList() {
  ...
  return (
    <Box>
      <Header />
      <Flex w='100%' justify="center" my="6" maxW={1480}  px={["4", "4", "6"]}>
        <Sidebar />
          ...
          <Table colorScheme="whiteAlpha">
            ...
            <Tbody>
              <Tr>
                ...
                <Td>
                  <Box>
                    <Text fontWeight="bold">Guilherme Alcantara</Text>
                    <Text fontSize="sm" color="gray.300">gui.absilva@outlook.com</Text>
                  </Box>
                </Td>
